...
public class Citadels {
    ...
    static int iii = 0;
    private static Player crown ;
    private static List<Player> players;
    private static List<Group> associations;
    private static List<Group> roundAssociations;
    ...
    private static void initialisation (){
        ...
        crown = players.maxBy(Player::age).get();
    }
    ...
    private static void scoreCalculation(){
